...
function App() {
  ...
  const url = `${baseURL}/project/${projectId}?preferencesProfile=hello-world#&organization=${organization}&token=${token}`;
  return (
    <div className="h-full w-full bg-[#5C71F2] flex">
      <div className="flex flex-col gap-2 p-4">
        ...
        <div>
          <div className="text-white font-bold">ProjectId</div>
          <input
            type="text"
            className="rounded p-1"
            value={projectId}
